...
urlpatterns = [
    ...
    url(r'tipo/item/busca/$', views.tipo_item_filter, name='tipo_item_search'),
    url(r'tipo/equip/busca/$', views.tipo_equip_filter, name='tipo_equip_search'),
    url(r'model/search/$', views.modelo_filter, name='model_search'),
    url(r'^itens/$', views.ItemListView.as_view(), name='item_list'),
